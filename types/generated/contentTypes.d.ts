...
export interface ApiCarritoItemCarritoItem extends Struct.CollectionTypeSchema {
  collectionName: 'carrito_items';
  info: {
    displayName: 'Carrito_item';
    pluralName: 'carrito-items';
    singularName: 'carrito-item';
  };
  options: {
...
export interface ApiCarritoCarrito extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    carrito_items: Schema.Attribute.Relation<
      'oneToMany',
      'api::carrito-item.carrito-item'
    >;
    creadoEn: Schema.Attribute.DateTime;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    estado: Schema.Attribute.Enumeration<['activo', 'cerrado']>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::carrito.carrito'
...
export interface ApiPagoLinkPagoLink extends Struct.CollectionTypeSchema {
  collectionName: 'pago_links';
  info: {
    displayName: 'Pago_link';
    pluralName: 'pago-links';
    singularName: 'pago-link';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    expira_en: Schema.Attribute.Date;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiPagoPago extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::pago.pago'> &
      Schema.Attribute.Private;
    lugar_pago: Schema.Attribute.Enumeration<['Web', 'Local']> &
      Schema.Attribute.Required;
    metodo_pago: Schema.Attribute.Enumeration<
      ['Debito', 'Cr\u00E9dito', 'Efectivo']
    >;
    monto: Schema.Attribute.Decimal;
    nro_boleta: Schema.Attribute.Text &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    pedido: Schema.Attribute.Relation<'oneToOne', 'api::pedido.pedido'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPedidoPedido extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    baucher: Schema.Attribute.String;
    codigo_pedido: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    comprobante_tranferencia: Schema.Attribute.Media<'images'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    direccion_usuario: Schema.Attribute.String;
    donde_se_genero: Schema.Attribute.Enumeration<['web', 'local']>;
    email_usuario: Schema.Attribute.Email;
    entrgado: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    ...
    pago: Schema.Attribute.Relation<'oneToOne', 'api::pago.pago'>;
    pago_link: Schema.Attribute.Relation<
      'oneToOne',
      'api::pago-link.pago-link'
    >;
    ...
    transferencia: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user: Schema.Attribute.Relation<
...
export interface ApiProductoProducto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    categoria: Schema.Attribute.Relation<
      ...
      'api::categoria.categoria'
    >;
    codigo_barra: Schema.Attribute.Text & Schema.Attribute.Unique;
    ...
    imagen_link: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::carrito-item.carrito-item': ApiCarritoItemCarritoItem;
      'api::carrito.carrito': ApiCarritoCarrito;
      'api::categoria.categoria': ApiCategoriaCategoria;
      'api::pago-link.pago-link': ApiPagoLinkPagoLink;
